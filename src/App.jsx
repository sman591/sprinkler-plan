  ...
  return (
    <div className="min-h-screen bg-slate-900 flex items-center justify-center p-8">
      <div className="max-w-lg w-full space-y-6">
        ...
        {step === 'upload' && (
          <div className="bg-slate-800 rounded-2xl p-8 border-2 border-dashed border-slate-600 hover:border-blue-500 transition-colors">
            <label className="flex flex-col items-center gap-4 cursor-pointer">
              <div className="text-5xl">🌿</div>
              <div className="text-center">
                <p className="text-white font-medium">Upload a photo of your lawn</p>
                <p className="text-slate-400 text-sm mt-1">Aerial or overhead photos work best</p>
              </div>
